    ...
    <Layout>
      <Chapter id="services-intro" tone="white" className="pt-36 md:pt-44">
        <PageHeader
          ...
          lead="Τρεις τρόποι να δουλέψουμε μαζί: κατασκευή, προώθηση, ή ο συνδυασμός που χρειάζεται η δουλειά σας. Καμία τιμή δεν κρύβεται πίσω από «κατόπιν επικοινωνίας»."
        />
