...
export const services: Service[] = [
  {
    ...
    detailLead:
      'Πληρώνετε μία φορά για την κατασκευή και η ιστοσελίδα είναι δική σας. Δεν υπάρχει υποχρεωτική μηνιαία συνδρομή για να παραμείνει online — μόνο το κόστος domain και hosting, που το πληρώνετε απευθείας στον πάροχο.',
    detailGroups: [
      {
      ...
      },
      {
        ...
        items: [
          'Mobile-first: σχεδιάζουμε πρώτα για το κινητό και μετά για την οθόνη',
      ...
      },
      {
        ...
        items: [
          'Σύνδεση domain, ρύθμιση DNS και πιστοποιητικό SSL',
