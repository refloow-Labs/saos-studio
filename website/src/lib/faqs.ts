...
export const faqs: Faq[] = [
  {
    ...
    a: 'Χρησιμοποιούμε AI για να επιταχύνουμε τον σχεδιασμό και τον προγραμματισμό, μειώνοντας τον χρόνο παραγωγής από εβδομάδες σε μέρες. Περνάμε αυτή την εξοικονόμηση σε εσάς, ενώ ένας έμπειρος σχεδιαστής ελέγχει και εκλεπτύνει κάθε παράδοση. Δεν πληρώνετε γραφειοκρατία, μεσάζοντες ή ώρες που δεν παρήγαγαν τίποτα.',
    category: 'pricing',
    onHome: true,
  },
  {
  ...
  },
  {
    ...
    a: 'Συμπληρώνετε μια σύντομη φόρμα με επτά ερωτήσεις: ποιος είστε, σε ποιον κλάδο δραστηριοποιείστε, γιατί κάνετε αίτηση, αν έχετε ήδη ιστοσελίδα και πώς μπορούμε να επικοινωνήσουμε μαζί σας. Χρειάζεται περίπου δύο λεπτά και θα λάβετε απάντηση με email είτε η αίτηση γίνει δεκτή είτε όχι.',
    category: 'pricing',
